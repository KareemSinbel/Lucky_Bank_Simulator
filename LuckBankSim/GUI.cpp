    ...
    while (window.pollEvent(event)) 
    {
        if (event.TouchEnded)
        {
            for (int i = 0, name = 0; name < C.Name.size(); i++, name++)
            {
                ...
                sf::FloatRect city1 = Board[i].getGlobalBounds();
                if (i == 0 || i == 3 || i == 7 || i == 10 || i == 12 || i == 14 || i == 17 || i == 20 || i == 24 || i == 29 || i == 31)
                {
                    name--;
                }
                else if (city1.contains(mousePos))
                {
...
void GUI::loadboard()
{
    ...
    ClubOfLuck.loadFromFile("Images\\ClubOfLuck.jpg");
    ...
    Board[7].setTexture(&ClubOfLuck);
    ClubOfLuck.setSmooth(true);

    //Rectangles of the Right side of the board .... starts from down

    jail.loadFromFile("Images\\Jail.jpg");
    ...
    BusStation.loadFromFile("Images\\BusStation.jpg");
    ...
    Board[17].setTexture(&BusStation);
    BusStation.setSmooth(true);
...
void GUI::drawrect()
{
    ...
    for (int i = 0,name = 0; name < C.Name.size(); i++, name++)
    {
        ...
        {
            name--;
            Board[i].setSize(sf::Vector2f(100, 100));
            Board[i].setOutlineColor(outlineColor);
            Board[i].setOutlineThickness(outlineThickness);
            Board[i].setPosition(Board[i].getPosition());
            window.draw(Board[i], multiplicativeBlending);
        }    
        else
        {
            Board[i].setSize(sf::Vector2f(100, 100));
...
void GUI::citydat()
{
    if (isopen2 == true && playbuttonbool == true)
    {
        ...
        string1.setString("Name :");
        string1.setCharacterSize(15);
        string1.setFillColor(outlineColor);
        string1.setStyle(sf::Text::Bold);
        string1.setPosition(1335, 100);

        string2.setFont(font);
        string2.setString("Price :");
        string2.setCharacterSize(15);
        string2.setFillColor(outlineColor);
        string2.setStyle(sf::Text::Bold);
        string2.setPosition(1335, 150);

        font.loadFromFile(ARIAL_FONT);
        nam.setFont(font);
        nam.setString(C.Name[info]);
        nam.setCharacterSize(15);
        nam.setFillColor(outlineColor);
        nam.setStyle(sf::Text::Bold);
        nam.setPosition(1400, 100);

        price.setFont(font);
        price.setString(to_string(C.Price[info]));
        price.setCharacterSize(15);
        price.setFillColor(outlineColor);
        price.setStyle(sf::Text::Bold);
        price.setPosition(1400, 150);

        passfees.setFont(font);
        passfees.setString(to_string(C.PassingFees[info]));
        passfees.setCharacterSize(15);
        passfees.setFillColor(outlineColor);
        passfees.setStyle(sf::Text::Bold);
        passfees.setPosition(1400, 200);

        window.draw(nam);
        window.draw(price);
        window.draw(passfees);
        window.draw(string1);
        window.draw(string2);
    }
}
...
void GUI::boardaction()
{

}

//void GUI::passobject(citydata& x)
//{
//
//}
// 
